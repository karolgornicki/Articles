...
productsHorizontal = getHorizontalProducts

productsVertical :: [[Int]] -> [[Int]]
productsVertical = getHorizontalProducts . transpose 

calcDiag1 :: [[Int]] -> [[Int]] 
calcDiag1 = concat . map (getVerticalProducts . shift) . groupByN 4
